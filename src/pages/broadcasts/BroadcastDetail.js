...
function BroadcastDetail(){
    ...
    const loadPeopleForBroadcast=()=>{
        axios.get(`http://localhost:8080/broadcasts/${id}/people`)
            .then(res=>{
    ...
    const loadTagsForBroadcast=()=>{
        axios.get(`http://localhost:8080/broadcasts/${id}/tags`)
            .then(res=>{
                //console.log(res.data)
                setTags(res.data)
            })
    ...
    const addPerson=(personId)=>{
        axios.put(`http://localhost:8080/broadcasts/${id}/addPerson/${personId}`)
            .then(res=>{
    ...
    const removePerson=(personId)=>{
        axios.put(`http://localhost:8080/broadcasts/${id}/removePerson/${personId}`)
            .then(res=>{
    ...
    const addTag=(tagId)=>{
        axios.put(`http://localhost:8080/broadcasts/${id}/addTag/${tagId}`)
            .then(res=>{
    ...
    const removeTag=(tagId)=>{
        axios.put(`http://localhost:8080/broadcasts/${id}/removeTag/${tagId}`)
            .then(res=>{
